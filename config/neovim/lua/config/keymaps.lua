...
-- vim.keymap.set('n', '<S-l>', '<C-w><C-l>', { desc = 'Move focus to the right window', silent = true })
-- vim.keymap.set('n', '<S-k>', '<C-w><C-k>', { desc = 'Move focus to the upper window', silent = true })
-- vim.keymap.set('n', '<S-j>', '<C-w><C-j>', { desc = 'Move focus to the lower window', silent = true })
